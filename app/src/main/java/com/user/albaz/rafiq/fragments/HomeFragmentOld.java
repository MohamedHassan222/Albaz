...
import com.user.albaz.rafiq.utils.MyCheckbox;
...
public class HomeFragmentOld extends Fragment implements OnMapReadyCallback, DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private void refreshAccessToken(final String tag) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLHelper.login, object, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.d("rrrrrrrrrr",response.toString());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                String Message;
                NetworkResponse response = error.networkResponse;
                Log.d("eeeeeeeeeeeeeeee",error.getMessage());
                if (response != null && response.data != null) {
                                ...
                                switch (status) {
                                    ...
                                    case "ACCEPTED":
                                        ...
                                        try {
                                            ...
                                            //Picasso.with(activity).load(URLHelper.base+"storage/"+provider.optString("avatar")).placeholder(R.drawable.loading).error(R.drawable.loading).into(provider_image);
                                            ...
                                            //Picasso.with(activity).load(service_type.optString("image")).placeholder(R.drawable.loading).error(R.drawable.loading).into(serviceRequestedImg);
                                    ...
                                    case "DROPPED":
                                        ...
                                        try {
                                            ...
                                            if (isPaid.equalsIgnoreCase("0") && paymentMode.equalsIgnoreCase("CASH")) {
                                                ...
                                                //Picasso.with(activity).load(provider.optString("avatar")).placeholder(R.drawable.loading).error(R.drawable.loading).into(rateProviderImg);
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            if (jsonArray.optJSONObject(position).optString("status").equalsIgnoreCase("1")) {
                ...
                if (position == currentPostion) {
                    ...
                    Picasso.with(activity).load(jsonArray.optJSONObject(position).optString("image")).placeholder(R.drawable.loading).error(R.drawable.loading).into(holder.serviceImg);
    ...
    void showProviderPopup(JSONObject jsonObject) {
        Picasso.with(activity).load(jsonObject.optString("image")).placeholder(R.drawable.pickup_drop_icon)
