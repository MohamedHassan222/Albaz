...
public class ForgetPassword extends AppCompatActivity {
    ...
    private void forgetPassword() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLHelper.FORGET_PASSWORD, object, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                email.setFocusableInTouchMode(false); // rafiq touches widget on phone with touch screen
                    ...
                    try {
                        ...
                        if(response.statusCode == 400 || response.statusCode == 405 || response.statusCode == 500){
                            ...
                            try{
                                ...
                                displayMessage(ForgetPassword.this.getString(R.string.try_again));
                            }
    ...
    private void resetpassword() {
        ...
        try {
            ...
            object.put("land", Utilities.getDeviceLocal());
